 ...
 */
public class FragPesanan2 extends Fragment implements Callback<JsonElement> {
     ...
     */
    public static FragPesanan2 newInstance(String param1, String param2) {

        FragPesanan2 fragment = new FragPesanan2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.pesanan_frag2, container, false);
    ...
    public void load(){
        ...
        String idUserLogin;
        Call<JsonElement> call = apIinterface.getstatus_menunggu(
                idUserLogin = SessionLog.GetId(getContext())
        );
        Log.d("TAG", "onResponse: " );
        call.enqueue(FragPesanan2.this);
    }
    @Override
