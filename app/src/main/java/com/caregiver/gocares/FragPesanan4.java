 ...
 */
public class FragPesanan4 extends Fragment implements Callback<JsonElement> {
     ...
     */
    public static FragPesanan4 newInstance(String param1, String param2) {

        FragPesanan4 fragment = new FragPesanan4();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.pesanan_frag4, container, false);
    ...
    public void load(){
        ...
        String idUserLogin;
        Call<JsonElement> call = apIinterface.getstatus_merawat(
                idUserLogin = SessionLog.GetId(getContext())
        );
        Log.d("TAG", "onResponse: " );
        call.enqueue(FragPesanan4.this);
    }
