 ...
 */
public class FragPesanan5 extends Fragment implements Callback<JsonElement> {
     ...
     */
    public static FragPesanan5 newInstance(String param1, String param2) {

        FragPesanan5 fragment = new FragPesanan5();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.pesanan_frag5, container, false);
    ...
    public void  load(){
        ...
        String idUserLogin;
        Call<JsonElement> call = apIinterface.getstatus_diterima(
                idUserLogin = SessionLog.GetId(getContext())
        );
        Log.d("TAG", "onResponse: " );
        call.enqueue(FragPesanan5.this);
    }
    @Override
