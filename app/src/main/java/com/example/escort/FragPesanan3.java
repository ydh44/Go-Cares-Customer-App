 ...
 */
public class FragPesanan3 extends Fragment implements Callback<JsonElement> {
     ...
     */
    public static FragPesanan3 newInstance(String param1, String param2) {

        FragPesanan3 fragment = new FragPesanan3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.pesanan_frag3, container, false);
    ...
    public void load(){
        ...
        String idUserLogin;
        Call<JsonElement> call = apIinterface.getstatus_dikonfirmasi(
                idUserLogin = SessionLog.GetId(getContext())
        );
        Log.d("TAG", "onResponse: " );
        call.enqueue(FragPesanan3.this);
    }
